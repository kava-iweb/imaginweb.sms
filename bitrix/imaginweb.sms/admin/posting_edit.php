...
$aTabs = array(
	array("DIV" => "edit1", "TAB" => GetMessage("IMAGINWEB_SMS_post_posting_tab"), "ICON" => "main_user_edit", "TITLE" => GetMessage("IMAGINWEB_SMS_post_posting_tab_title")),
	array("DIV" => "edit2", "TAB" => GetMessage("IMAGINWEB_SMS_post_subscr_tab"), "ICON" => "main_user_edit", "TITLE" => GetMessage("IMAGINWEB_SMS_post_subscr_tab_title")),
	array("DIV" => "edit3", "TAB" => GetMessage("IMAGINWEB_SMS_post_params_tab"), "ICON" => "main_user_edit", "TITLE" => GetMessage("IMAGINWEB_SMS_post_params_tab_title")),
);
...
if($REQUEST_METHOD == "POST" && ($save.$apply.$Send.$Resend.$Continue != "") && $POST_RIGHT == "W" && check_bitrix_sessid()){
	...
	if($res){
		...
		if($apply != ""){
			$_SESSION["SESS_ADMIN"]["POSTING_EDIT_MESSAGE"] = array("MESSAGE" => GetMessage("IMAGINWEB_SMS_post_save_ok"), "TYPE" => "OK");
		...
		if($e = $APPLICATION->GetException()){
			$message = new CAdminMessage(GetMessage("IMAGINWEB_SMS_post_save_error"), $e);
		}
		$bVarsFromForm = true;
	}
}
...
$APPLICATION->SetTitle(($ID > 0 && !$bCopy ? GetMessage("IMAGINWEB_SMS_post_title_edit").$ID : GetMessage("IMAGINWEB_SMS_post_title_add")));

require($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/main/include/prolog_admin_after.php");

$aMenu = array(
	array(
		"TEXT"=>GetMessage("IMAGINWEB_SMS_post_mnu_list"),
		"TITLE"=>GetMessage("IMAGINWEB_SMS_post_mnu_list_title"),
...
if($ID > 0 && !$bCopy)
{
	...
	$aMenu[] = array(
		"TEXT" => GetMessage("IMAGINWEB_SMS_post_mnu_add"),
		"TITLE" => GetMessage("IMAGINWEB_SMS_post_mnu_add_title"),
		"LINK" => "imaginweb.sms_posting_edit.php?lang=".LANG,
		"ICON" => "btn_new",
	);
	$aMenu[] = array(
		"TEXT" => GetMessage("IMAGINWEB_SMS_post_mnu_copy"),
		"TITLE" => GetMessage("IMAGINWEB_SMS_post_mnu_copy_title"),
		"LINK" => "imaginweb.sms_posting_edit.php?ID=".$ID."&amp;action=copy&amp;lang=".LANG,
		"ICON" => "btn_copy",
	);
	$aMenu[] = array(
		"TEXT" => GetMessage("IMAGINWEB_SMS_post_mnu_del"),
		"TITLE" => GetMessage("IMAGINWEB_SMS_post_mnu_del_title"),
		"LINK" => "javascript:if(confirm('".GetMessage("IMAGINWEB_SMS_post_mnu_confirm")."'))window.location='imaginweb.sms_posting_admin.php?ID=".$ID."&action=delete&lang=".LANG."&".bitrix_sessid_get()."';",
		"ICON" => "btn_delete",
	);
}
...
<form method="POST" Action="<?=$APPLICATION->GetCurPage();?>"  ENCTYPE="multipart/form-data" name="post_form">
	...
	?>
		<tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_info")?></td>
		</tr>
	<?if($ID > 0 && !$bCopy):?>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_date_upd")?></td>
			<td><?=$str_TIMESTAMP_X;?></td>
		</tr>
		<?if(strlen($str_DATE_SENT)>0):?>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_date_sent")?></td>
			<td><?=$str_DATE_SENT;?></td>
		</tr>
		<?endif;?>
		<?
		...
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_POST_TO")?></td>
			<td>[&nbsp;<a class="tablebodylink" href="javascript:void(0)" OnClick="jsUtils.OpenWindow('posting_bcc.php?ID=<?=$str_ID?>&lang=<?=LANG?>&find_status_id=E&set_filter=Y', 600, 500);"><?=GetMessage("IMAGINWEB_SMS_POST_SHOW_LIST")?></a>&nbsp;]</td>
		</tr>
		<?endif;?>
	<?endif; //ID?>
		<tr>
			<td width="40%"><?=GetMessage("IMAGINWEB_SMS_post_stat")?></td>
			<td width="60%">
	<?
	if($ID > 0 && !$bCopy){
	...
	?>
		...
		<?if($ID>0 && !$bCopy && $str_STATUS!="D"):?>
			<tr>
				<td><?=GetMessage("IMAGINWEB_SMS_post_status_change")?></td>
				<td>
				<select class="typeselect" name="STATUS">
					<option value=""><?=GetMessage("IMAGINWEB_SMS_post_status_not_change")?></option>
		...
		<?endif;?>
		<tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_fields")?></td>
		</tr>
		<tr>
			<td><span class="required">*</span><?=GetMessage("IMAGINWEB_SMS_post_fields_from")?></td>
			<td><input type="text" name="FROM_FIELD" value="<?=$str_FROM_FIELD;?>" size="30" maxlength="11"></td>
		</tr>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_fields_to")?></td>
			<td><input type="text" name="TO_FIELD" value="<?=$str_TO_FIELD;?>" size="30" maxlength="255"></td>
		</tr>
		<tr>
			<td><span class="required">*</span><?=GetMessage("IMAGINWEB_SMS_post_fields_subj")?></td>
			<td><input type="text" name="SUBJECT" value="<?=$str_SUBJECT;?>" size="30" maxlength="255"></td>
		</tr>
		<tr class="heading">
			<td colspan="2"><span class="required">*</span><?=GetMessage("IMAGINWEB_SMS_post_fields_text")?><span class="required"><sup>1</sup></span></td>
		</tr>
	...
	?>
		<tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_subscr")?></td>
		</tr>
		<tr>
			<td width="50%"><?=GetMessage("IMAGINWEB_SMS_post_rub")?></td>
			<td width="50%">
		...
		<tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_users")?></td>
		</tr>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_groups")?></td>
			<td>
		...
		<tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_filter_title")?></td>
		</tr>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_filter")?></td>
		...
		<tr>
			...
			CheckAll('GROUP_ID');
			//-->
			</script>[ <a class="tablebodylink" title="<?=GetMessage("IMAGINWEB_SMS_post_list_title")?>" href="javascript:ShowEMails()"><?=GetMessage("IMAGINWEB_SMS_post_filter_list")?></a> ]</td>
		</tr>
		<tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_additional")?></td>
		</tr>
		<tr>
	...
	?>
		<!-- <tr class="heading">
			<td colspan="2"><?=GetMessage("IMAGINWEB_SMS_post_send_params")?></td>
		</tr>
		<tr>
			<td width="50%"><?=GetMessage("IMAGINWEB_SMS_post_direct")?></td>
			<td width="50%">
		...
		<tr>
			<td width="50%"><?=GetMessage("IMAGINWEB_SMS_post_send_flag")?></td>
			<td width="50%">
				<input type="checkbox" name="AUTO_SEND_FLAG" value="Y"<?if($str_AUTO_SEND_FLAG == "Y") echo " checked"?> OnClick="EnableAutoSend()">
			</td>
		</tr>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_send_time"). " (".FORMAT_DATETIME."):"?><span class="required"><sup>1</sup></span></td>
	...
	//-->
		...
		<tr>
			<td width="50%"><?=GetMessage("IMAGINWEB_SMS_post_send_flag")?></td>
			<td width="50%"><? echo ($str_AUTO_SEND_FLAG == "Y" ? GetMessage("IMAGINWEB_SMS_post_yes") : GetMessage("IMAGINWEB_SMS_post_no"))?></td>
		</tr>
		<tr>
			<td><?=GetMessage("IMAGINWEB_SMS_post_send_time"). " (".FORMAT_DATETIME."):"?><span class="required"><sup>1</sup></span>
	...
	<?if($str_STATUS=="D"):?>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?if ($POST_RIGHT<"W") echo "disabled" ?> type="submit" value="<?=GetMessage("IMAGINWEB_SMS_post_butt_send")?>" name="Send" title="<?=GetMessage("IMAGINWEB_SMS_post_hint_send")?>">
	<?elseif($str_STATUS=="W"):?>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?if ($POST_RIGHT<"W") echo "disabled" ?> type="submit" value="<?=GetMessage("IMAGINWEB_SMS_post_continue")?>" name="Continue" title="<?=GetMessage("IMAGINWEB_SMS_post_continue_conf")?>">
	<?elseif($str_STATUS=="E"):?>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?if ($POST_RIGHT<"W") echo "disabled" ?> type="submit" value="<?=GetMessage("IMAGINWEB_SMS_post_resend")?>" name="Resend" title="<?=GetMessage("IMAGINWEB_SMS_post_resend_conf")?>">
	<?endif?>
	<?if($ID > 0):?>
		<?if($bCopy):?>
...
<br>
<span class="required"><sup>1</sup></span><?=GetMessage("IMAGINWEB_SMS_post_send_msg")?><br>
<?=EndNote();?>
